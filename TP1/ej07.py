...
def suma_dias(dia:int, mes:int, anio:int, n:int) -> tuple:
    ...
    return fecha_actualizada #retorno en una tupla la fecha actualizada sumandole n dias


#b Calcular la cantidad de días existentes entre dos fechas cualquiera.
def diferencia_entre_fechas(dia1:int, mes1:int, anio1:int, dia2:int, mes2:int, anio2:int) -> int:
    """
...
print(f"La diferencia de dias entre {dia1, mes1, anio1} y {dia2, mes2, anio2} es de {diferencia_final} dias.")